...
export const KNOWN_LABELS = {
  ...
  NAVIGATED: "NAVIGATED",
  BRIDGE_EXECUTION_STARTED: "BRIDGE_EXECUTION_STARTED",
  BRIDGE_EXECUTION_UPDATED: "BRIDGE_EXECUTION_UPDATED",
  BRIDGE_EXECUTION_COMPLETED: "BRIDGE_EXECUTION_COMPLETED",
